...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('inc/dev/css/grids.css'); ?>" media="screen">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('inc/dev/css/main.css'); ?>" media="screen">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('inc/dev/css/header.css'); ?>" media="screen">
    ...
    <![endif]-->
    <script src="<?php echo base_url('inc/dev/js/libs/jquery.min.js'); ?>"></script>
    <script src="<?php echo base_url('inc/dev/js/bootstrap.min.js'); ?>"></script>
    <script src="<?php echo base_url('inc/dev/js/app.js'); ?>"></script>    
    <script src="<?php echo base_url('inc/dev/js/forms.js'); ?>"></script>    
    ...
    <link rel="shortcut icon" href="<?php echo base_url('inc/img/ico/favicon.png'); ?>"> 
  </head>
<body>
